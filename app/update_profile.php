...
if (isset($_POST['new_password']) && isset($_POST['confirm_password']) && isset($_POST['password']) && isset($_POST['full_name']) && $_SESSION['role'] == 'employee') {
   ...
   if (empty($password) || empty($new_password) || empty($confirm_password)) {
		...
		$em = "New Password Does not Match";
	    header("Location: ../edit_profile.php?error=$em");
	    exit();
	}else {
