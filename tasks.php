...
<body>
	...
	<div class="body">
		...
		<section class="section-1">
			<h4 class="title-2"><?=$text?>
				<a href="create_task.php" class="btn">Create Task</a>
				<a href="tasks.php?due_date=Overdue" class="delete-btn">Overdue</a>
				<a href="tasks.php?due_date=Due Today" class="edit-btn">Due Today</a>
				<a href="tasks.php?due_date=No Deadline" class="delete-btn">No Deadline</a>
				<a href="tasks.php" class="btn">All Tasks</a>
			</h4>
			<h4><i>Total Tasks: <?=$c_task?><i></h4>
